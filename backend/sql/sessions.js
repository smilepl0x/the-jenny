export const SESSIONS = {
  ...
  GET_SESSIONS_FOR_CHANNEL: `SELECT * FROM sessions s LEFT JOIN games g ON g.game_id = s.game_id WHERE channel_id=?`,
  ...
  UPDATE_SESSION_MESSAGE_ID: `UPDATE sessions SET message_id=? WHERE message_id=?`,
